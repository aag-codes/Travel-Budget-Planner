...
class HolidayAI:
    """Provides AT-powered travel advice using the Gemini API."""
    def __init__(self):
    ...
    def get_trave_advice(self, destination: str, budget: float, currency: str) -> str | None:
        prompt = f"""
    ...
    def get_budget_breakdown_advice(self,destination: str, budget: float, currency: str) -> str | None:
        ...
        Suggest a realistic budget breakdown across these categoreis:
        - Accommodation
        - Flood
        - Transport 
        - Activities
